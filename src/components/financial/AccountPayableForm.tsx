...
export const AccountPayableForm: React.FC<AccountPayableFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (account) {
        ...
        await financialService.accountsPayable.update(account.id, formData);
        toast.success('Conta a pagar atualizada com sucesso!');
      } else {
        // Criar nova conta
        await financialService.accountsPayable.create(formData);
   ...
   */
  const expenseCategories = localCategories.filter(cat => cat.type === TransactionType.EXPENSE && cat.isActive);
